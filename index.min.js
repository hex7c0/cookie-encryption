...
var arc4 = null, autokey = null, crypto = require("crypto"), inherits = require("util").inherits, getCipher = new Array([ "arc4", "rc4a", "vmpc", "rc4+" ], crypto.getCiphers(), crypto.getHashes(), [ "modp1", "modp2", "modp5", "modp14", "modp15", "modp16", "modp17", "modp18" ], [ "pbkdf2" ], [ "autokey" ]);
...
}, inherits(Signed, Main), inherits(Normal, Main), Signed.prototype.read = function(req, cookie, encoding) {
    var ck, o;
...
}, module.exports = cookiee, module.exports.getCiphers = getCiphers;
